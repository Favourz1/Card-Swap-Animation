...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function setActiveCard(activeSelector) {
    const allCards = document.querySelectorAll(".section2-card");
    allCards.forEach((card) => card.classList.add("section2-overlay-card"));
    const activeCard = document.querySelector(activeSelector);
    if (activeCard) {
      activeCard.classList.remove("section2-overlay-card");
    }
  }
  ...
  function updateHeaderText(cardNumber) {
    const headerElement = document.querySelector(
      ".section2-cards-section-header"
    );
    if (!headerElement) return;

    // Define section2-card-specific content
    const cardContent = {
      1: "Our flexible model helps ease pressure off your marketing team.",
  ...
  if (window.innerWidth >= 768) {
    const tl = gsap.timeline({
      scrollTrigger: {
        trigger: ".section2-cards-section",
        start: "top top",
    ...
    // -------------------------------------------------------------------------
    // We have 5 cards: section2-card-1 (center initially), section2-card-2, section2-card-3, section2-card-4, section2-card-5.
    ...
    // Immediately declare which card is active at the start (section2-card-1)
    // This .call() fires at the very beginning (time=0)
    tl.call(
      () => {
        setActiveCard(".section2-card-1");
        updateHeaderText(1);
      },
      null,
      0
    ...
    tl.to(
      ...
      // After step 1 completes, section2-card-2 is active
      .call(() => {
        setActiveCard(".section2-card-2");
        updateHeaderText(2);
      });
    ...
    tl.to(".section2-card-4", {
      ...
      // After step 2 completes, section2-card-4 is active
      .call(() => {
        setActiveCard(".section2-card-4");
        updateHeaderText(4);
      });
    ...
    tl.to(".section2-card-5", {
      ...
      // After step 3 completes, section2-card-5 is active
      .call(() => {
        setActiveCard(".section2-card-5");
        updateHeaderText(5);
      });
    ...
    tl.to(".section2-card-3", {
      ...
      // After step 4 completes, section2-card-3 is active
      .call(() => {
        setActiveCard(".section2-card-3");
        updateHeaderText(3);
      });
    ...
    allCards.forEach((card) => {
      card.classList.remove("section2-overlay-card");
      gsap.set(card, {
        scale: 1,
        transform: "none",
      });
